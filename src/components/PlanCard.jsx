export default function PlanCard({ name, price, icon, freeMonths = '', selected, changePlanOption, period = 'mo' }) {
  return (
    <div
      ...
      className={`${selected ? "border-purplishBlue" : ""} border-1 border-solid border-lightGray hover:border-purplishBlue rounded-lg p-3 w-full flex sm:flex-col sm:justify-between`}>
